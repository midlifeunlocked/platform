 ...
 *
 * The Webflow catalogue is frozen (no further updates), so THIS FILE is now the
 * canonical source — hand-edit it directly. Webflow is kept only for reference.
 * (e.g. Romeo Lewis added by hand as Dean Gladwyn’s co-guest — Webflow could not
 * model two guests.) In Phase 3 this is replaced by live Supabase queries.
 */
